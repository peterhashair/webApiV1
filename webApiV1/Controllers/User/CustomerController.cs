...
namespace webApiV1.Controllers.User
{
    ...
    public class CustomerController : ControllerBase
    {
        ...
        public CustomerController(UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signInManager, RoleManager<ApplicationRole> roleManager, IConfiguration configuration)
        {
